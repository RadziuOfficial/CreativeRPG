...
local czcionka = dxCreateFont(":crpg_fonty/f.ttf", 11)
...
addEventHandler("onClientRender", root, function()
	for i,v in ipairs(editboxs) do
		...
		dxDrawRectangle(v[7]-2, v[8], v[9]+4, v[10], tocolor(0,94,254,175), true)
		dxDrawRectangle(v[7]-(2)+screenW*0.0010, v[8]+screenW*0.0010, v[9]+(4)-screenW*0.0020, v[10]-screenW*0.0020, tocolor(15,15,15,255), true)
